            ...
            return MaterialApp(
                  home: Scaffold(
                      ...
                      appBar: AppBar(
                            ...
                            title: const Text("ElevatedButton"),      // *const  for *Immutable object.
                            centerTitle: true,
                      ...
                      // -------------------------
                      body: Center(
                            child: ElevatedButton(        // *Target Widget
                                  onPressed: () => {},

                                  style: ElevatedButton.styleFrom(
                                        backgroundColor: Colors.white60,
                                        foregroundColor: Colors.red,
                                        textStyle: const TextStyle(         // *const  for *Immutable object.
                                              fontSize: 18.0,
                                              fontWeight: FontWeight.bold,
                                              fontStyle: FontStyle.italic
                                        ),
                                  ...
                                  child: const Text(      // *const  for *Immutable object.
                                        "This is a ElevatedButton Widget."
                                  ),
                            ),
                      ),
                ),
